...
void acti_oLED() 
{
	...
	display.drawString(0, 6, "READY");
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 22, "SSID=");
	display.drawString(30, 22, WiFi.SSID());
  display.drawString(0, 32, "IP=");
  display.drawString(14, 32, WiFi.localIP().toString());
//#elif OLED==2
//  display.setFont(ArialMT_Plain_16);
//  display.drawString(0, 0, "READY");
//  display.setFont(ArialMT_Plain_10);
//  display.drawString(0, 16, "SSID=");
//  display.drawString(40, 26, WiFi.SSID());
